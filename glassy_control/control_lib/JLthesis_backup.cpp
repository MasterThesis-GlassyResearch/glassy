...
//     K_drag_est_.diagonal() << ku_param_update[0], ku_param_update[1], ku_param_update[2], ku_param_update[3], ku_param_update[4], kr_param_update[0], kr_param_update[1], kr_param_update[2], kr_param_update[3], kr_param_update[4];
...
//         \\TODO
//     */
//     Eigen::Vector2d desired_accelerations = ref_star_dot - (tracking_err/tracking_err.norm())*(p_err.transpose()*delta_mat_*tracking_err )- Kp_*tracking_err - Ki_*(Eigen::Matrix2d::Identity()+Kd_).inverse().transpose()*integral_vec_ - Kd_*tracking_err_deriv ; 
