...
def generate_launch_description():
    ...
    world = os.path.join(PX4_DIR, 'Tools/sitl_gazebo/worlds/expo_lisbon_simple.world')
    ...
    return LaunchDescription([
        ...
        SetEnvironmentVariable('GAZEBO_MODEL_PATH', GAZEBO_MODEL_PATH+':'+  PX4_DIR + '/Tools/sitl_gazebo/models' + ':'+ PX4_DIR + '/Tools/sitl_gazebo/Media'),
