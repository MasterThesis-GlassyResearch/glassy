...
def generate_launch_description():
    ...
    # define path to gazebo classic 
    path_to_gazebo = 'Tools/simulation/gazebo-classic/sitl_gazebo-classic'

    
    # Get the gazebo package directory
    # gazebo_launch_dir = os.path.join(get_package_share_directory('gazebo_ros'), 'launch')
    world = os.path.join(PX4_DIR, path_to_gazebo,'/worlds/ocean.world')
    ...
    return LaunchDescription([
        ...
        SetEnvironmentVariable('GAZEBO_MODEL_PATH', PX4_DIR +path_to_gazebo+'/models'),
        ...
        ExecuteProcess(
        cmd=['make px4_sitl gazebo-classic_glassy'],
        output='screen'),     
